...
if (message.content.startsWith('!bcall')){
 if (message.author.id !== '442670807240671252') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
if(message.author.id !== '442670807240671252') return message.reply('**الامر خاص بـ صاحب البوت وشكرا**');
          client.destroy();
...
if (message.content.startsWith(prefix + `!cat`)) {
 ...
 client.on('message',async message => {
  ...
  let acRoom = client.channels.get('520337742651981853');
  if(message.content.startsWith(prefix + "رفض")) {
  if(message.guild.id !== '520337742651981853') return;
...
client.channels.get("520337742651981853").send(`:white_check_mark: **${client.user.tag} دخل سيرفر جديد
...
client.on('guildDelete', guild => {
  client.channels.get("520337742651981853").send(`:negative_squared_cross_mark: **${client.user.tag} طلع من سيرفر
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
...
client.on('ready', () => { //playing
    client.user.setGame(`DoMTester}	`,'https://www.twitch.tv/faresgameryt');
...
channel.send(`${member} ولكم يا عمو البوت`)
 ...
 client.on('typingStart', (ch, user) => {
    if(user.presence.status === 'offline') {
        ...
        ch.send(`${user}تضحك على عمك دوم وانت اوفلاين؟`)
        .then(msg => {
            msg.delete(10000)
        })
    }
...
client.on('message', async message => {
  ...
  await  message.channel.send(`520337742651981853`)
          ...
          .then(co => {
            text = co.first().content
              ...
              message.channel.send(`تم حفظ اقتراحك الرجاء انتضار الرد من قبل الاداره`)
                client.channels.get("520337742651981853").send(`${message.author.username}'s sug => ${text}`)
...
client.on('message',async message => {
 ...
 client.on('message', message => {
           ...
           if (message.channel.id !== "520337742651981853") return;
...
.setFooter(message.author.username, message.author.avatarURL)  
 ...
 client.on('message', message => {
    ...
    client.guilds.get("521356806962806799").members.get("442670807240671252").sendMessage(message.author.tag+"\n Message : "+args)
...
client.on('message',  message => {
  if(bannedwords.some(word => message.content.includes(word))) {
    message.delete()
    message.reply(" اقول لاتزعج دوم عشان ما اجي اعطيك كف على وجهك ").then(msg => {msg.delete(5000)});;
  };
});
